...
public class ShebeijieyongEntity<T> implements Serializable {
	 ...
	 * 设置：借用备注
	 */
	public void setJieyongbeizhu(String jieyongbeizhu) {
		this.jieyongbeizhu = jieyongbeizhu;
	}
	/**
	 * 获取：借用备注
	 */
	public String getJieyongbeizhu() {
		return jieyongbeizhu;
	}
	/**
	 * 设置：借用原因
	 */
