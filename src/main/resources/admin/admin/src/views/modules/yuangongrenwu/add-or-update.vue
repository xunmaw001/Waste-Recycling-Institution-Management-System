<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="任务汇报" prop="renwuhuibao">
          <el-select :disabled="ro.renwuhuibao" v-model="ruleForm.renwuhuibao" placeholder="请选择任务汇报">
            <el-option
                v-for="(item,index) in renwuhuibaoOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="任务汇报" prop="renwuhuibao">
	      <el-input v-model="ruleForm.renwuhuibao"
                placeholder="任务汇报" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="下发人" prop="xiafaren">
          <el-input v-model="ruleForm.xiafaren" 
              placeholder="下发人" clearable  :readonly="ro.xiafaren"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="下发人" prop="xiafaren">
              <el-input v-model="ruleForm.xiafaren" 
                placeholder="下发人" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.xiafashijian" label="下发时间" prop="xiafashijian">
              <el-input v-model="ruleForm.xiafashijian" 
                placeholder="下发时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yaoqiushijian = true;
          ...
          if(o=='renwuhuibao'){
            this.ruleForm.renwuhuibao = obj[o];
	    this.ro.renwuhuibao = true;
            continue;
          }
          if(o=='lianxiren'){
	    ...
	    this.ro.lianxidianhua = true;
          ...
          if(o=='xiafaren'){
            this.ruleForm.xiafaren = obj[o];
	    this.ro.xiafaren = true;
            continue;
          }
          if(o=='xiafashijian'){
      ...
      this.$http({
		...
		if(this.$storage.get("role")!="管理员") {
          ...
          this.$message.error(data.msg);
            ...
            this.renwuhuibaoOptions = "已汇报,待汇报".split(',')
    },
    // 下二随
	...
	this.ruleForm.gongzuoneirong = this.ruleForm.gongzuoneirong.replace(reg,'../../../springboot1332i/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `yuangongrenwu/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.yuangongrenwuCrossAddOrUpdateFlag = false;
						 this.parent.search();
