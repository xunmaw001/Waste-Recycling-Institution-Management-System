    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="借用原因" prop="jieyongyuanyin">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="借用原因"
                  v-model="ruleForm.jieyongyuanyin" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jieyongyuanyin" label="借用原因" prop="jieyongyuanyin">
                    <span>{{ruleForm.jieyongyuanyin}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="借用备注" prop="jieyongbeizhu">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.jieyongbeizhu" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jieyongbeizhu" label="借用备注" prop="jieyongbeizhu">
                    <span v-html="ruleForm.jieyongbeizhu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jieyongshijian = true;
          ...
          if(o=='jieyongbeizhu'){
            this.ruleForm.jieyongbeizhu = obj[o];
	    this.ro.jieyongbeizhu = true;
            continue;
          }
          if(o=='jieyongyuanyin'){
	...
	this.ruleForm.jieyongbeizhu = this.ruleForm.jieyongbeizhu.replace(reg,'../../../springboot1332i/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
