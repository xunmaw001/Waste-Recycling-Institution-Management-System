    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="报修原因" prop="baoxiuyuanyin">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.baoxiuyuanyin" label="报修原因" prop="baoxiuyuanyin">
                    <span>{{ruleForm.baoxiuyuanyin}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="报修备注" prop="baoxiubeizhu">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.baoxiubeizhu" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.baoxiubeizhu" label="报修备注" prop="baoxiubeizhu">
                    <span v-html="ruleForm.baoxiubeizhu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	shhf : false,
      ...
      rules: {
          ...
          baoxiubeizhu: [
                { required: true, message: '报修备注不能为空', trigger: 'blur' },
          ],
          baoxiuyuanyin: [
  ...
  methods: {
	...
	this.ruleForm.baoxiubeizhu = this.ruleForm.baoxiubeizhu.replace(reg,'../../../springboot1332i/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
