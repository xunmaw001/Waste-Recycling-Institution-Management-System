<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="请假编号" prop="qingjiabianhao">
          <el-input v-model="ruleForm.qingjiabianhao" 
              placeholder="请假编号" clearable  :readonly="ro.qingjiabianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="请假编号" prop="qingjiabianhao">
              <el-input v-model="ruleForm.qingjiabianhao" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="请假时长" prop="qingjiashizhang">
          <el-input v-model="ruleForm.qingjiashizhang" 
              placeholder="请假时长" clearable  :readonly="ro.qingjiashizhang"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="销假说明" prop="xiaojiashuoming">
          <el-input v-model="ruleForm.xiaojiashuoming" 
              placeholder="销假说明" clearable  :readonly="ro.xiaojiashuoming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="销假说明" prop="xiaojiashuoming">
              <el-input v-model="ruleForm.xiaojiashuoming" 
                placeholder="销假说明" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  created() {
	this.ruleForm.xiaojiashijian = this.getCurDateTime()
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.qingjiashizhang = true;
          ...
          if(o=='xiaojiashuoming'){
            this.ruleForm.xiaojiashuoming = obj[o];
	    this.ro.xiaojiashuoming = true;
            continue;
          }
          if(o=='xiaojiashijian'){
