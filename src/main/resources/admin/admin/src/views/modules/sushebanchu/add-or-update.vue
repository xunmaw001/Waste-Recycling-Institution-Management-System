<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="楼栋号" prop="loudonghao">
          <el-input v-model="ruleForm.loudonghao" 
              placeholder="楼栋号" clearable  :readonly="ro.loudonghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="楼栋号" prop="loudonghao">
              <el-input v-model="ruleForm.loudonghao" 
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `sushebanchu/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.sushebanchuCrossAddOrUpdateFlag = false;
						 this.parent.search();
