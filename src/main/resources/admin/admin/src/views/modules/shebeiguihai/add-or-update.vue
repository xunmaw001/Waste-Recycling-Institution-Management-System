    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="归还备注" prop="guihaibeizhu">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.guihaibeizhu" label="归还备注" prop="guihaibeizhu">
                    <span v-html="ruleForm.guihaibeizhu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	shhf : false,
      ...
      rules: {
          ...
          guihaibeizhu: [
                { required: true, message: '归还备注不能为空', trigger: 'blur' },
          ],
          yuangonggonghao: [
          ],
          yuangongxingming: [
  ...
  methods: {
	...
	this.ruleForm.guihaibeizhu = this.ruleForm.guihaibeizhu.replace(reg,'../../../springboot1332i/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
