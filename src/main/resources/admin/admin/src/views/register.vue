      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='yuangong'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.gangwei" class="input" type="text" placeholder="岗位">
			   </div>
			 </div> -->
			<el-form-item label="岗位" class="input" v-if="tableName=='yuangong'">
			  <el-input v-model="ruleForm.gangwei" autocomplete="off" placeholder="岗位"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yuangong'" class="input-group">
